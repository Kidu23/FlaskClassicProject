...
class AllCoinsApiIO:
    ...
    def getAllCoins(self,apikey):
        ...
        self.total_coins = r.json()
        

        for dic in self.total_coins:
...
class Exchange:
    def __init__(self, coinTo, coinFrom):
        self.rate = None
    ...
    def updateExchange(self,apikey):
        url = f"https://rest.coinapi.io/v1/exchangerate/{self.coin_from}/EUR?apikey={APIKEY}"#this is the request to acces the link
